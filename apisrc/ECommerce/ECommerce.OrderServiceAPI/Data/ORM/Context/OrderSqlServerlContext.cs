...
public class OrderSqlServerlContext : BaseDbContext
{

    public OrderSqlServerlContext(ConfigurationApplication configurationApplication)
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.ApplyConfigurationsFromAssembly(typeof(OrderSqlServerlContext).Assembly);
    }
